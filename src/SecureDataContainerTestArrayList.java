...
public class SecureDataContainerTestArrayList {
    ...
    private static void testContainer(SecureDataContainerArrayList<String> container) {
        ...
        //Should throw "no user" exception
        try {
            container.unshare("User3","passUser3","User2","samsung");
        } catch (NoUserException e){
            System.out.println("no user");
        }
    ...
    public static void main(String[] args) {
        SecureDataContainerArrayList<String> arrayListContainer = new SecureDataContainerArrayList<>();
        testContainer(arrayListContainer);
    }
}
